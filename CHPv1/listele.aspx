		...
		<div class="container">
            ...
            <form id="form1" runat="server">
                <div>
                    ...
                    <asp:DropDownList ID="ddlSandikNo" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlSandikNo_SelectedIndexChanged"></asp:DropDownList>

                    <div class="dataTables_wrapper no-footer">
                        <asp:GridView ID="grdPeople" runat="server" AllowPaging="True" CssClass="table table-striped table-hover table-bordered dataTable no-footer" EnableSortingAndPagingCallbacks="True"  AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnRowEditing="RowUpdate" OnRowCancelingEdit="RowCancelling" OnRowDeleting="RowDeleting" OnRowUpdating="RowUpdating">
