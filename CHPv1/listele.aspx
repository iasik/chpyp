		...
		<div class="container">
            ...
            <form id="form1" runat="server" class="form-horizontal">
                <div class="row margin-bottom-20">
                    ...
                    <asp:GridView ID="grdPeople" runat="server" AllowPaging="True" CssClass="table table-striped table-hover table-bordered dataTable no-footer" EnableSortingAndPagingCallbacks="True"  AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AutoGenerateSelectButton="True" >
