            ...
            <form id="form1" runat="server">
                <div>
                    ...
                    <div class="dataTables_wrapper no-footer">
                        <asp:GridView ID="grdPeople" runat="server" AllowPaging="True" CssClass="table table-striped table-hover table-bordered dataTable no-footer" EnableSortingAndPagingCallbacks="True"  AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnRowEditing="RowUpdate">
